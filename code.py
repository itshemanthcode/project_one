...
pygame.mixer.init()
pygame.mixer.music.load('alarm.wav')  # Add the path to your alarm sound file
    ...
    while cap.isOpened():
        ...
        if face_result.multi_face_landmarks:
            ...
            if closed_eyes_frame_count >= CLOSED_EYE_FRAMES:
                ...
                # Stop the alarm if neither drowsiness nor yawning is detected
                if alarm_playing and closed_eyes_frame_count == 0 and mar < MAR_THRESHOLD:
        ...
        # Display the frame
        cv2.imshow("Drowsiness and Face Detection", frame)
